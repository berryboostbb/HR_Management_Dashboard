...
export default function ImagePicker({
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        className={`rounded-md w-full h-14 px-3 py-2 flex items-center justify-between border-[#0755E9] border-[0.5px] cursor-pointer transition-all duration-200 ${
      ...
      >
        <div className="flex items-center gap-3">
          {uploading ? (
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 border-2 border-[#0755E9] border-t-transparent rounded-full animate-spin"></div>
        ...
        {!uploading && (
          <RiFolderUploadFill size={22} className="text-[#0755E9]" />
        )}
      </div>
