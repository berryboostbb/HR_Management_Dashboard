          ...
          <div className="mt-6 bg-white border border-[#8FB1FF] rounded-xl p-5">
            ...
            <div className="flex flex-wrap gap-y-4 gap-x-6">
              ...
              <div className="flex items-center justify-between w-full md:w-[48%]">
                ...
                <div className="border border-[#D9D9D9] rounded px-2 py-[2px] text-[12px] min-w-[50px] text-center">
              ...
              <div className="flex items-center justify-between w-full md:w-[48%]">
                ...
                <div className="border border-[#D9D9D9] rounded px-2 py-[2px] text-[12px] min-w-[50px] text-center text-[#B0B0B0]">
