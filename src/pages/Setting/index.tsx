    ...
    <div className="bg-[#F7F7F7] md:h-[calc(100vh-108px)] h-auto rounded-xl p-4">
      <div className="bg-[#E5EBF7] p-4 rounded-xl h-auto">
        <div
          ...
          className="scroll-smooth bg-white p-4 rounded-xl 2xl:h-[calc(82vh-0px)] xl:h-[calc(64.4vh-0px)] overflow-y-auto scrollbar-none"
        >
          <p className="mb-2 text-lg font-semibold">Office Timing</p>

          <div className="flex gap-5 w-[50%] pt-3">
            <TimePicker
